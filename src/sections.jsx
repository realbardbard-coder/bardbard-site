...
function HeroAvatar({ name, tagline, avatar }) {
  const a = avatar || {};
  const src    = a.src || "assets/bard-avatar-v3.jpg";
...
function PortfolioGrid() {
  ...
  const items = [
  { brand: "Sui Network", title: "Sui Price Speculation", blurb: "Community engagement tweet.", date: "Aug 4 · 2026", views: "20K+", icon: "pin", color: "#5be3ff", href: "https://x.com/BardBard/status/2084277063188730173" },
